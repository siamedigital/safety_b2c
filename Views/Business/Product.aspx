...
<body class="default" id="page-product">
    ...
    <div id="main-wrapper">
        <header id="header-wrapper">
            <div id="header">
                ...
                <!--#include file="../Shared/header-business.aspx"-->
            </div>
            <!-- header -->
        </header>
        <!-- #header-wrapper -->
            ...
            <div class="breadcrumb-section absolute">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#nogo" title="ประกันภัยธุรกิจ">ประกันภัยธุรกิจ</a></li>
                        <li class="active"><span>SMEs</span></li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="title-wrapper">
                                    <h3 class="title">ประกันภัยธุรกิจขนาดย่อม</h3>
                                    <p class="description">Shop House Package catered specifically for shops, retail outlets, offices and simple occupancies</p>
                                </div>
                            </div>
                            <div class="col-xs-12">
                                <div class="tab-wrapper">
                                            ...
                                            <div class="content-editor-wrapper">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <tr class="topic">
                                                                <td style="width: 40%;">1. การประกันอัคคีภัย ฟ้าผ่า การระเบิด แผ่นดินไหว</td>
                                                                <td rowspan="5">
                                                                    คลินิก,สถานรับเลี้ยงเด็ก,
                                                                    ฟิตเนสเซนเตอร์,
                                                                ...
                                                                <td rowspan="5">
                                                                    ...
                                                                    ร้านตัดเย็บเสื้อผ้า, ร้านให้เช่า
                                                                    อัดวิดีโอ, โรงกลึง 
                                                                    (ไม่มีผลิตภัณฑ์ไม้)
                                                                </td>
                                                                <td rowspan="5">
                                                            ...
                                                            <tr class="topic">
                                                                <td style="width: 40%;">
                                                                    2. ภัยลมพายุ, ภัยเนื่องจากน้ำ, ภัยเนื่องจากควัน, 
                                                            ...
                                                            <tr class="topic">
                                                                <td style="width: 40%;">
                                                                    3. ภัยเนื่องจากการจลาจลและการนัดหยุดงาน, 
                                                                    ภัยเนื่องจากป่าเถื่อนและเจตนาร้าย 
                                                                    และภัยต่อเครื่องไฟฟ้า
                                                                </td>
                                                            </tr>
                                                            <tr class="topic">
                                                                <td style="width: 40%;">
                                                                    4. ทรัพย์สินที่เอาประกันภัย และค่าซ่อมแซมอาคาร
                                                                    ที่เสียหาย
                                                                </td>
                                                            </tr>
                                                            <tr class="topic">
                                                                <td>
                                                                    5. ความรับผิดตามกฏหมายต่อชีวิตและทรัพย์สิน
                                                                    ของบุคคลภายนอก
                                                                </td>
                                                            </tr>
                                                            <tr class="summary">
                                                                <td style="width: 40%;">ทุนประกันภัย 300,000 บาทแรก
                                                                </td>
                                                                <td>900 บาท
                                                                </td>
                                                                <td>1,200 บาท
                                                            ...
                                                            <tr class="summary">
                                                                <td style="width: 40%;">ทุนประกันภัยเพิ่มทุก 100,000 บาท
                                                                </td>
                                                                <td>100 บาท
                                                                </td>
                                                                <td>150 บาท
                                    ...
                                    <div class="btn-wrapper txt-center">
                                        ...
                                        <div class="gen-button inline-block">
                                            <a href="/Business/Buy" class="btn-med btn-icon-right btn-primary" title="ซื้อเลย!">ซื้อเลย <i class="fas fa-angle-right" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $('#top-menu-left li#Business').addClass('current');

        $('#menu li').removeClass('current');
        $('#menu li#SME').addClass('current');
    </script>
