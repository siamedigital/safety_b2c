    ...
    <div id="main-wrapper">
        ...
        <div id="main-slider" class="main-slider">
            <div class="index-slider slider-container">
                <div id="foo">
                    <div class="foo-item">
                        <img src="../../Images/ta/banner-02.jpg" />
                    </div>
                </div>
            ...
            <div class="breadcrumb-section absolute">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="/Travel">ประกันภัยเดินทาง</a></li>
                        <li class="active"><span>Go Asia</span></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <%
                                ...
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Travel/Plan.aspx" -->
                            <%        }
                                else if (Request.QueryString["p"] == "2")
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Travel/Cart1.aspx" -->
                            <%        }
                                else if (Request.QueryString["p"] == "3")
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Travel/Cart2.aspx" -->
                            <%        }
                                else if (Request.QueryString["p"] == "4")
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Travel/Checkout.aspx" -->
                            <%        }
                                else if (Request.QueryString["p"] == "5")
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Travel/Payment.aspx" -->
                            <%        }
                            ...
                            <%        }
                                ...
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Travel/Compare.aspx" -->
                            <%        }
                                else
                                {
                            %>
