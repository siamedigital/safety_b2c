    ...
    <div id="main-wrapper">
        ...
        <div id="main-slider" class="main-slider">
            <div class="index-slider slider-container">
                <div id="foo">
                    <div class="foo-item">
                        <img src="../../Images/motor/banner-02.jpg" />
                    </div>
                </div>
            ...
            <div class="breadcrumb-section absolute">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#nogo" title="ประกันภัยรถยนต์">ประกันภัยรถยนต์</a></li>
                        <li class="active"><span>ประกันภัยรถยนต์ภาคบังคับ (พ.ร.บ.)</span></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <%
                                ...
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Motor/Plan.aspx" -->
                            <%        }
                                else if (Request.QueryString["p"] == "2")
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Motor/Cart1.aspx" -->
                            <%        }
                                else if (Request.QueryString["p"] == "3")
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Motor/Cart2.aspx" -->
                            <%        }
                                else if (Request.QueryString["p"] == "4")
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Motor/Checkout.aspx" -->
                            <%        }
                                else if (Request.QueryString["p"] == "5")
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Motor/Payment.aspx" -->
                            <%        }
                            ...
                            <%        }
                                else if (Request.QueryString["p"] == "7")
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Motor/Compare.aspx" -->
                            <%        }
                                else
                                {
                            %>
