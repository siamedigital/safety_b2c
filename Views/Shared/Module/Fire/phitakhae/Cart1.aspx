        ...
        <div class="content-form">
            <form>
                ...
                <div class="row form-row">
                    ...
                    <div class="col-sm-4">
                        <div class="gen-input">
                            <input class="" id="" name="" placeholder="ระบุ" value="" autocomplete="off" type="tel">
                        </div>
                    </div>
                </div>
                ...
                <div class="row form-row">
                    ...
                    <div class="col-sm-4">
                        <div class="gen-slc">
                            <select class="selectpicker" title="เลือกอาชีพ">
                                <option data-tokens="ระบุ">ระบุ</option>
                                <option data-tokens="ระบุ">ระบุ</option>
                                <option data-tokens="ระบุ">ระบุ</option>
                            </select>
                    ...
                    <div class="col-sm-4 col-sm-offset-4">
                        <div class="btn-wrapper">
                            <div class="gen-button">
                                <button type="button" class="btn-med btn-icon-right btn-primary" onclick="location.href='/Fire/Buy_Phitakhae?p=3'">NEXT STEP <i class="fas fa-angle-right" aria-hidden="true"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
