        ...
        <div class="content-form">
            <form>
                ...
                <div class="row form-row">
                    ...
                    <div class="col-sm-4">
                        <div class="custom-radio">
                            <input value="" id="rdo_livestatus_renter" name="rdo_fire_livestatus" type="radio">
                            <label for="rdo_livestatus_renter"></label>
                            <span class="content-rdo-inline-block">ผู้เช่า</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row form-row">
                    ...
                    <div class="col-sm-4">
                        <div class="custom-radio">
                            <input value="" id="rdo_wall_2" name="rdo_wall" type="radio">
                            <label for="rdo_wall_2"></label>
                            <span class="content-rdo-inline-block">ก่ออิฐ/ไม้</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row form-row">
                    ...
                    <div class="col-sm-4">
                        <div class="custom-radio">
                            <input value="" id="rdo_upperfloor_2" name="rdo_upperfloor" type="radio">
                            <label for="rdo_upperfloor_2"></label>
                ...
                <div class="row form-row">
                    ...
                    <div class="col-sm-4">
                        <div class="custom-radio">
                            <input value="" id="rdo_roof_structure_1" name="rdo_roof_structure" type="radio">
                            <label for="rdo_roof_structure_1"></label>
                ...
                <div class="row form-row">
                    ...
                    <div class="col-sm-4">
                        <div class="custom-radio">
                            <input value="" id="rdo_roof_2" name="rdo_roof" type="radio">
                            <label for="rdo_roof_2"></label>
                    ...
                    <div class="col-sm-4 col-sm-offset-4">
                        <div class="btn-wrapper">
                            <div class="gen-button">
                                <button type="button" class="btn-med btn-icon-right btn-primary" onclick="location.href='/Fire/Buy_Phitakhae?p=4'">NEXT STEP <i class="fas fa-angle-right" aria-hidden="true"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
