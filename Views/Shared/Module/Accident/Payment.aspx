            ...
            <div class="order-wrapper">
                <div class="row">
                    ...
                    <div class="col-sm-3 col-xs-6 txt-right">
                        <h3 class="order-amount">2,000.<span>00</span> <span class="unit">บาท</span></h3>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-8">
                        <div class="gen-button">
                            <button type="submit" class="btn-med btn-primary" onclick="location.href='/Motor/Buy?p=6'" data-dismiss="modal">ชำระเบี้ยประกัน</button>
                        </div>
                    </div>
                </div>
            </div>
