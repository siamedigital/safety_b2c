<div class="form-wrapper">
    ...
    <div class="form-content-wrapper">
        <div class="title-form">
            <h3><span>เลือกแบบประกัน</span> : ประกันอุบัติเหตุส่วนบุคคล</h3>
        </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane" id="tab3">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="gen-input">
                                                <input class="dateinput" id="birthDate3" name="" placeholder="วัน/เดือน/ปี" value="" autocomplete="off" type="text">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div role="tabpanel" class="tab-pane" id="tab4">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="gen-input">
                                                <input class="dateinput" id="birthDate4" name="" placeholder="วัน/เดือน/ปี" value="" autocomplete="off" type="text">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-sm-4 col-sm-offset-4">
                        <div class="btn-wrapper">
                            <div class="gen-button">
                                <button type="button" class="btn-med btn-icon-left btn-dark" onclick="location.href='/Accident/Buy?p=1'"><i class="fas fa-angle-left" aria-hidden="true"></i> ย้อนกลับ</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="btn-wrapper">
                            <div class="gen-button">
                                <button type="button" class="btn-med btn-icon-right btn-primary" onclick="location.href='/Accident/Buy?p=4'">NEXT STEP <i class="fas fa-angle-right" aria-hidden="true"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
