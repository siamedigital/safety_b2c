    ...
    <div id="main-wrapper">
        ...
        <div id="main-slider" class="main-slider">
            <div class="index-slider slider-container">
                <div id="foo">
                    <div class="foo-item">
                        <img src="../../Images/pa/banner-02.jpg" />
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <%
                                ...
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Accident/Plan.aspx" -->
                            <%        }
                                else if (Request.QueryString["p"] == "2")
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Accident/Cart1.aspx" -->
                            <%        }
                                else if (Request.QueryString["p"] == "3")
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Accident/Cart2.aspx" -->
                            <%        }
                                else if (Request.QueryString["p"] == "4")
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Accident/Checkout.aspx" -->
                            <%        }
                                else if (Request.QueryString["p"] == "5")
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Accident/Payment.aspx" -->
                            <%        }
                            ...
                            <%        }
                                ...
                                {
                            %>
                            <!-- #include file ="../Shared/Module/Accident/Compare.aspx" -->
                            <%        }
                                else
                                {
                            %>
