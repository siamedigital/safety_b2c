                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="title-wrapper matchHeight">
                                        ...
                                        <h3 class="description">ประกันอัคคีภัยสำหรับบ้านพิทักษ์เคหะ</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="title-wrapper">
                                    <h3 class="title">ประกันอัคคีภัยสำหรับบ้านพิทักษ์เคหะ</h3>
                                ...
                                <div class="tab-wrapper">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="topic">
                                                                <td>
                                                                    2. ค่าใช้จ่าย และ/หรือค่าเช่าเพื่อที่พักอาศัยชั่วคราว
                                                                </td>
                                                                <td>
                                                                    ไม่เกิน 1,200 บาท/วัน ไม่เกิน 30,000 บาท/ครั้งและไม่เกิน 1 เดือน
                                                                </td>
                                                                <td>
                                                                    ไม่เกิน 1,500 บาท/วัน ไม่เกิน 36,000 บาท/ครั้งและไม่เกิน 1 เดือน
                                                                </td>
                                                                <td>
                                                                    ไม่เกิน 2,000 บาท/วัน ไม่เกิน 45,000 บาท/ครั้งและไม่เกิน 1 เดือน
                                                                </td>
                                                                <td>
                                                                    ไม่เกิน 3,000 บาท/วัน ไม่เกิน 60,000 บาท/ครั้งและไม่เกิน 1 เดือน
                                                                </td>
                                                            </tr>
                                                            <tr class="topic">
                                                                <td>
                                                            ...
                                                            <tr class="topic">
                                                                <td>
                                                                    4. โจรกรรมงัดแงะ ชิงทรัพย์ ปล้นทรัพย์
                                                                </td>
                                                                <td>
                                                                    ไม่เกิน 7,000 บาท/ชิ้น และไม่เกิน 100,000 บาท/ครั้ง/ปี
                                                                </td>
                                                                <td>
                                                                    ไม่เกิน 8,000 บาท/ชิ้น และไม่เกิน 100,000 บาท/ครั้ง/ปี
                                                                </td>
                                                                <td>
                                                                    ไม่เกิน 10,000 บาท/ชิ้น และไม่เกิน 100,000 บาท/ครั้ง/ปี
                                                                </td>
                                                                <td>
                                                                    ไม่เกิน 10,000 บาท/ชิ้น และไม่เกิน 100,000 บาท/ครั้ง/ปี
                                                                </td>
                                    ...
                                    <div class="calculate-insurance">
                                        <div class="note-wrapper">
                                            <p class="color-red">หมายเหตุ การเพิ่มทุกประกันอัคคีภัย</p>
                                            <p>ทุนประกันภัยเพิ่มทุกๆ 100,000 บาท คิดเบี้ยประกันภัยเพิ่ม 100 บาท<br />
                                                ความคุ้มครองตั้งแต่ ข้อ 2-6 ของแผน 1 ใช้ทุนประกันต่ำกว่า 600,000 บาท<br />
                                                ความคุ้มครองตั้งแต่ ข้อ 2-6 ของแผน 2 ใช้ทุนประกันต่ำกว่า 1,000,000 บาท<br />
                                                ความคุ้มครองตั้งแต่ ข้อ 2-6 ของแผน 3 ใช้ทุนประกันต่ำกว่า 1,200,000 บาท<br />
                                                ความคุ้มครองตั้งแต่ ข้อ 2-6 ของแผน 4 ใช้ทุนประกันต่ำกว่า 1,200,000 บาท
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="btn-wrapper txt-center">
                                        ...
                                        <div class="gen-button inline-block">
                                            <a href="/Fire/Buy_Phitakhae" class="btn-med btn-icon-right btn-primary" title="ซื้อเลย!">ซื้อเลย <i class="fas fa-angle-right" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
